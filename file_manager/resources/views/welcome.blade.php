...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('home/css/isotope.css') }}" media="screen" />
    <link rel="stylesheet" href="{{asset('home/js/fancybox/jquery.fancybox.css')}}" type="text/css" media="screen" />
    <link href="{{asset('home/css/animate.css')}}" rel="stylesheet" media="screen">
    <link href="{{asset('home/js/owl-carousel/owl.carousel.css')}}" rel="stylesheet">
    <link rel="stylesheet" href="{{asset('home/css/styles.css')}}" />
    <link href="{{asset('home/font/css/font-awesome.min.css')}}" rel="stylesheet">
</head>
<body>
<header class="header">
  <div class="container">
    <nav class="navbar navbar-inverse" role="navigation">
      <div class="navbar-header">
        ...
        <a href="#" class="navbar-brand scroll-top logo  animated bounceInLeft"><b><i><img src="{{asset('3.png')}}" /></i></b></a> </div>
      <!--/.navbar-header-->
...
<section id="home">
  ...
  <div class="carousel-inner">
    <div class="active item"><img src="{{asset('home/images/banner-bg.jpg') }}" alt="banner" /></div>
    <div class="item"><img src="{{asset('home/images/banner-bg2.jpg') }}" alt="banner" /></div>
    <div class="item"><img src="{{asset('home/images/banner-bg3.jpg') }}" alt="banner" /></div>
  </div>
  <!-- Carousel nav -->
  ...
  <div class="container hero-text2">        
		<div class="col-md-9">
		<h2>Why Edulogy?</h1>
			<p>Download  All Lectures OR Videos uploaded by your collage's stuff  </p>   
		</div>  
        <div class="col-md-3">
          <a class="btn btn-apply" href={{route('register')}}><i class="fa fa-play-circle"></i>Create Account Now</a>  
        </div>
        <div class="col-md-3">
          <a style="width: 120%;text-align: left;" class="btn btn-apply" href={{route('login')}}><i class="fa fa-play-circle"></i>Login</a>  
        </div>
  </div>
</section>
<section id="Features" class="page-section colord">
  <div class="container">
    <div class="row"> 
	  ...
	  <div class="box-item">
	  <i class="circle"><img src="{{asset('home/images/5.png')}}" alt="" /></i>
        <h3>Courses</h3>
      ...
      <div class="col-md-3 text-center">
	  <div class="box-item">
	  <i class="circle"> <img src="{{asset('home/images/1.png') }}" alt="" /></i>
        <h3>Lectures</h3>
        <p>Nullam ac rhoncus sapien, non gravida purus. Alinon elit imperdiet congue. Integer elit imperdiet congue.</p>
      </div>
	   </div>
      ...
      <div class="col-md-3 text-center">
	  <div class="box-item">
	  <i class="circle"> <img src="{{asset('home/images/2.png')}}" alt="" /></i>
        <h3>Videos</h3>
      ...
      <div class="col-md-3 text-center">
	  <div class="box-item">
	  <i class="circle"> <img src="{{asset('home/images/3.png')}}" alt="" /></i>
        <h3>Latest News</h3>
...
<section id="aboutUs">
  <div class="container">
    ...
    <div class="row feature design">
      ...
      <div class="area2 columns feature-media right"> <img src="{{asset('home/images/about-img.jpg') }}" alt="" width="100%"> </div>
    </div>
          ...
          <ul class="items list-unstyled clearfix animated fadeInRight showing" data-animation="fadeInRight" style="position: relative; height: 438px;">
            <li class="item branding" style="position: absolute; left: 0px; top: 0px;"> 
			  ...
			  <figure class="effect-bubba">
						<img src="{{asset('home/images/work/1.jpg') }}" alt="img02"/>
						<figcaption>
							<h2>B-Events</h2> 
							<a href="{{asset('home/images/work/1.jpg') }}" class="fancybox">View more</a> 
						</figcaption>			
					</figure> 
			...
			<figure class="effect-bubba">
						<img src="{{asset('home/images/work/2.jpg') }}" alt="img02"/>
						<figcaption>
							<h2>B-Events</h2> 
							<a href="{{asset('home/images/work/2.jpg') }}" class="fancybox">View more</a> 
						</figcaption>			
					</figure> 
			  </li>
            <li class="item branding" style="position: absolute; left: 585px; top: 0px;"> 
			<figure class="effect-bubba">
						<img src="{{asset('home/images/work/3.jpg') }}" alt="img02"/>
						<figcaption>
							<h2>B-Events</h2> 
							<a href="{{asset('home/images/work/3.jpg') }}" class="fancybox">View more</a> 
						</figcaption>			
					</figure>  
			  </li>
            <li class="item photography" style="position: absolute; left: 877px; top: 0px;"> 
			<figure class="effect-bubba">
						<img src="{{asset('home/images/work/4.jpg') }}" alt="img02"/>
						<figcaption>
							<h2>B-Events</h2> 
							<a href="{{asset('home/images/work/4.jpg') }}" class="fancybox">View more</a> 
						</figcaption>			
					</figure>  
			  </li>
            <li class="item photography" style="position: absolute; left: 0px; top: 219px;"> 
			<figure class="effect-bubba">
						<img src="{{asset('home/images/work/5.jpg') }}" alt="img02"/>
						<figcaption>
							<h2>B-Events</h2> 
							<a href="{{asset('home/images/work/5.jpg') }}" class="fancybox">View more</a> 
						</figcaption>			
					</figure> 
			  </li>
            <li class="item web" style="position: absolute; left: 292px; top: 219px;"> 
			<figure class="effect-bubba">
						<img src="{{asset('home/images/work/6.jpg') }}" alt="img02"/>
						<figcaption>
							<h2>B-Events</h2> 
							<a href="{{asset('home/images/work/6.jpg') }}" class="fancybox">View more</a> 
						</figcaption>			
					</figure> 
			  </li>
            <li class="item photography" style="position: absolute; left: 585px; top: 219px;">
			<figure class="effect-bubba">
						<img src="{{asset('home/images/work/7.jpg') }}" alt="img02"/>
						<figcaption>
							<h2>B-Events</h2> 
							<a href="{{asset('home/images/work/7.jpg') }}" class="fancybox">View more</a> 
						</figcaption>			
					</figure> 
			  </li>
            <li class="item web" style="position: absolute; left: 877px; top: 219px;">
			<figure class="effect-bubba">
						<img src="{{asset('home/images/work/8.jpg') }}" alt="img02"/>
						<figcaption>
							<h2>B-Events</h2> 
							<a href="{{asset('home/images/work/8.jpg') }}" class="fancybox">View more</a> 
						</figcaption>			
					</figure> 
			  </li>
          </ul>
      ...
      <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12"> 
          ...
          <div class="team-member pDark"> 
            ...
            <div class="member-img"> 
              <!-- Image  --> 
              <img class="img-responsive" src="{{asset('home/images/photo-1.jpg') }}" alt=""> </div>
            <!-- Member Details -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12"> 
          ...
          <div class="team-member pDark"> 
            ...
            <div class="member-img"> 
              <!-- Image  --> 
              <img class="img-responsive" src="{{asset('home/images/photo-2.jpg') }}" alt=""> </div>
            <!-- Member Details -->
            <h4>Larry Doe</h4>
            <!-- Designation --> 
        ...
        <div class="col-md-3 col-sm-6 col-xs-12"> 
          ...
          <div class="team-member pDark"> 
            ...
            <div class="member-img"> 
              <!-- Image  --> 
              <img class="img-responsive" src="{{asset('home/images/photo-3.jpg') }}" alt=""> </div>
            <!-- Member Details -->
            <h4>Ranith Kays</h4>
            <!-- Designation --> 
        ...
        <div class="col-md-3 col-sm-6 col-xs-12"> 
          ...
          <div class="team-member pDark"> 
            ...
            <div class="member-img"> 
              <!-- Image  --> 
              <img class="img-responsive" src="{{asset('home/images/photo-4.jpg') }}" alt=""> </div>
            <!-- Member Details -->
            <h4>Joan Ray</h4>
            <!-- Designation --> 
...
<script src="{{ asset('home/js/modernizr-latest.js') }}"></script> 
<script src="{{ asset('home/js/jquery-1.8.2.min.js') }}" type="text/javascript"></script> 
<script src="{{ asset('home/js/bootstrap.min.js') }}" type="text/javascript"></script> 
<script src="{{ asset('home/js/jquery.isotope.min.js') }}" type="text/javascript"></script> 
<script src="{{ asset('home/js/fancybox/jquery.fancybox.pack.js') }}" type="text/javascript"></script> 
<script src="{{ asset('home/js/jquery.nav.js') }}" type="text/javascript"></script> 
<script src="{{ asset('home/js/jquery.fittext.js') }}"></script> 
<script src="{{ asset('home/js/waypoints.js') }}"></script> 
 <script src="{{ asset('home/contact/jqBootstrapValidation.js') }}"></script>
 <script src="{{ asset('home/contact/contact_me.js') }}"></script>
<script src="{{ asset('home/js/custom.js') }}" type="text/javascript"></script> 
<script src="{{ asset('home/js/owl-carousel/owl.carousel.js') }}"></script>
</body>
</html>
